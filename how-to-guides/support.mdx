...
<Accordion title="Single‑Issue Focus Without Context">
...
<Accordion title="Looking for Code Instead of Solutions">
...
<Accordion title="User Problem Translation">
...
<Accordion title="Pattern Recognition & Impact Assessment">
...
<Accordion title="Issue Categorization & Prioritization">
...
<Accordion title="Cross‑System Issue Analysis">
...
<Accordion title="Immediate Solution Discovery">
...
<Accordion title="Work‑around Identification">
...
<Accordion title="Alternative Solution Paths">
...
<Accordion title="Temporary Fix Strategies">
...
<Accordion title="Explaining Technical Issues in User Terms">
...
<Accordion title="Setting Accurate Expectations">
...
<Accordion title="Providing Status Updates">
...
<Accordion title="Building User Confidence">
...
<Accordion title="Business Impact Communication">
...
<Accordion title="Preparing Technical Escalations">
...
<Accordion title="Gathering Diagnostic Information">
...
<Accordion title="Documentation for Knowledge Base">
...
<Accordion title="Escalation Impact Assessment">
...
<Accordion title="Proactive Issue Prevention">
...
<Accordion title="User Education & Guidance">
...
<Accordion title="Feedback Collection & Analysis">
...
<Accordion title="Customer Success Optimization">
...
<Accordion title="Historical Context Research">
