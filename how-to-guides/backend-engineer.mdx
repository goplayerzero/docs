...
<Accordion title="Single‑File Focus">
...
<Accordion title="Technology‑Specific Without Context">
...
<Accordion title="Generic Performance Questions">
...
<Accordion title="Infrastructure Without Application Context">
...
<Accordion title="System Architecture Intelligence">
...
<Accordion title="API Discovery and Tracing">
...
<Accordion title="Integration Pattern Analysis">
...
<Accordion title="Service Dependency Mapping">
...
<Accordion title="Database and Query Insights">
...
<Accordion title="Trace Data Flow">
...
<Accordion title="Data Consistency Analysis">
...
<Accordion title="User Data Privacy Audit">
...
<Accordion title="Production Issue Correlation">
...
<Accordion title="Real‑Time Issue Resolution">
...
<Accordion title="Performance and Scaling Context">
...
<Accordion title="Analyze Database Queries for Optimization">
...
<Accordion title="Handle Concurrent User Sessions">
...
<Accordion title="Trace Security Implementations">
...
<Accordion title="Complete OAuth Implementation">
...
<Accordion title="Handle Sensitive User Data">
...
<Accordion title="Check Permissions Across Services">
...
<Accordion title="Event Publishing and Consumption">
...
<Accordion title="Background Job Processing">
...
<Accordion title="Proactive Monitoring Setup">
...
<Accordion title="Business Metrics Monitoring">
