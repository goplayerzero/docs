---
title: "AI-Powered Workflows That Help Teams Win"
sidebarTitle: "User Workflows"
description: "PlayerZero turns chaos into clarity with workflow automations and augmentations that accelerate fixes, modernization, and quality."
---
...
<AccordionGroup>
  ...
  <Accordion title="Surface Code Conventions and Patterns">
    ...
    <CardGroup cols={1}>
      <Card title="Learn more about surfacing code conventions and patterns with PlayerZero" icon="code" href={'/how-to-guides/code-conventions-and-patterns'}>
      </Card>
    </CardGroup>
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Learn Business Rules and Team Patterns">
    ...
    <CardGroup cols={1}>
      <Card title="Learn more about learning business rules and team patterns with PlayerZero" icon="folder" href={'/how-to-guides/learn-business-rules-and-patterns'}>
      </Card>
    </CardGroup>
  </Accordion>
