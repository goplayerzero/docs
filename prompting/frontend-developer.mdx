...
## Prompting Best Practices and Examples
  ...
  ## Frontend Use Cases
<Note>Before you get started, double‑check which repositories and datasets PlayerZero has access to. You can find this in your settings at **go.playerzero.app/settings</Note>
