...
## Prompting Best Practices and Examples
    ...
    #### Effective Prompting Strategies
      ...
      2. **Provide Context About Your Goal**  
      ...
      3. **Combine Code Structure with User Experience**  
    ...
    #### Advanced Prompting Techniques
      1. **End‑to‑End Flow Tracing**  
         “I need to understand the complete user‑registration flow. First, show me the registration‑form component, then trace through the validation logic, API integration, and success/error handling.”  

      2. **Comparative Analysis**  
         “Compare how we handle loading states in the *old* user dashboard versus the *new* one, and show me what patterns we should standardize.”  

      3. **Impact Assessment**  
         “Show me all components that would be affected if we change the user‑authentication context API.”  

      4. **Historical Context**  
         “Show me how the payment component has evolved over the last month and what bugs were fixed.”  

  ## Frontend Use Cases
    > **TIP:** Before you get started, double‑check which repositories and datasets PlayerZero has access to. You can find this in your settings at **go.playerzero.app/settings**.
