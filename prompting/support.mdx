...
- **Solution Discovery:** Surface existing fixes, work‑arounds, and escalation paths based on codebase knowledge and issue patterns.  
...
## Support Use Cases  
> **TIP:** Before you start, double‑check which repositories and datasets PlayerZero can access at **go.playerzero.app/settings**.
