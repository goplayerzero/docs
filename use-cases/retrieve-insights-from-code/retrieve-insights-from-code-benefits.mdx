...
- [Ask Questions about Key Services, Files and Functions](/use-cases/retrieve-insights-from-code/ask-codebase-questions)
- [Identify Dependencies Across Files and Repos](/use-cases/retrieve-insights-from-code/identify-dependencies)
- [Enforce Coding Standards and Frameworks](/use-cases/retrieve-insights-from-code/enforce-coding-standards)
