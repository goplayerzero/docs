...
- [Generate Functional Tests with Context from your Entire Codebase](/use-cases/analyze-code-quality/generate-functional-tests)
- [Detect Regressions using Historical Context](/use-cases/analyze-code-quality/detect-regressions)
- [Create Line-by-Line Code Summaries](/use-cases/create-code-summaries)
