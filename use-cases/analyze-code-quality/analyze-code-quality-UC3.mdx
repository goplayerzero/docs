...
- [Create Detailed API Docs](mintlify://create-api-docs) – Convert endpoint definitions and descriptions into clean, readable API documentation.
- [Generate Architecture Diagrams](mintlify://generate-diagrams) – Visualize your system’s structure and dependencies automatically.
- [Produce User Guides](mintlify://generate-user-guides) – Transform complex flows into user-facing documentation for product and support teams.
- [Ask your Codebase Questions](mintlify://chat-codebase) – Use chat to dive deeper into how features are implemented or why decisions were made.
