...
- [Setup Alerts for User Issues](/use-cases/monitor-for-anomalies/setup-performance-alerts) – PlayerZero actively tracks and alerts teams to any issues that emerge after a deployment.
- [Mute any unwanted issues](/use-cases/monitor-for-anomalies/reduce-alert-noise) – Customize PlayerZero’s anomaly detection notifications to stay focused on the errors that truly matter.
