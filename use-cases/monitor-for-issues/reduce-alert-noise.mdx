...
Learn about how PlayerZero actively tracks and alerts teams to any issues that emerge after a deployment in the [Setup Alerts for User Issues](/use-cases/monitor-for-issues/setup-performance-alerts) guide.
