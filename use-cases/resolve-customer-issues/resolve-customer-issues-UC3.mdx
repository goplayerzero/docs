...
- [Retrieve Insights from Code](/use-cases/retrieve-insights-from-code/retrieve-insights-from-code-benefits) – Extract and interpret historical code behavior and patterns.

- [Ask your Codebase Questions](/use-cases/retrieve-insights-from-code/retrieve-insights-from-code-UC1) – Interact with your codebase using natural language queries and session-aware context.

- [Identify Dependencies](/use-cases/retrieve-insights-from-code/retrieve-insights-from-code-UC2) – Surface relationships between modules, services, and files to inform change impact.

- [Uphold Coding Standards](/use-cases/retrieve-insights-from-code/retrieve-insights-from-code-UC3) – Verify compliance with organizational practices across your codebase.
