...
<img
  src="/images/features/chrome-extension/chrome-extension-overview.png"
  alt="Chrome Extension side panel open alongside a webpage with floating toolbar visible"
/>
