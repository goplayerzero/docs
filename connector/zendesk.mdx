...
- **Add comments** — Post public replies or internal notes with investigation results and technical details
- **Search tickets** — Find related tickets and known issues when investigating problems
- **Manage tags** — Set or remove tags on tickets for categorization and routing
- **Search and retrieve users** — Find users by name or email and access user details
- **Browse organizations** — Retrieve organization details and list all organizations
- **Discover metadata** — List available ticket fields and support groups for routing decisions
