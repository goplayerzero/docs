...
<Note>**Beta Feature** — This integration uses Remote MCP Servers, which is currently in beta. To join the beta program, reach out to us at [help@playerzero.ai](mailto:help@playerzero.ai).</Note>
