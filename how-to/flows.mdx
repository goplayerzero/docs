...
When an issue begins blocking a flow within a specific view, you’ll get notified. Make sure you have a view you’re subscribed to by navigating to `Views`. For example, if I’m subscribed to a view that shows me all the issues in Production, if an issue starts affecting the “Checkout Flow” in the “Production”, I’ll get notified. 

Flows are also referenced as a checklist within your views. This helps you narrow down the issues you’re looking at quickly and get to the problems that really matter to your business.
