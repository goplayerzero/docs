...
- [**Instrument the WebSDK**](/developer-guide/configuration-guides/capturing-user-sessions/instrument-web-sdk)) – Enable user session tracking by integrating PlayerZero’s frontend WebSDK.
