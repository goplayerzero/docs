...
For an overview of all Slack capabilities — including message shortcuts, DMs with the bot, and @mention interactions — see [Slack connector overview](/connector/slack).
