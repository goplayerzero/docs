...
sidebarTitle: "Privacy & Performance"
description: "Understand how the PlayerZero SDK stays lightweight, efficient, and optimized for frontend performance."
---

## What is the PlayerZero SDK?

- **Identity & Tracing:** Joins the identity of the user with tracing data.
- **Frontend Observability:** Implements frontend observability and telemetry capture.
