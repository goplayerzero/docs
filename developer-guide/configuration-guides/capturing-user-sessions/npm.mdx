...
That's it! Once the SDK is installed and initialized, you can visit the [Users page](https://go.playerzero.app/users) in PlayerZero to see live user sessions being captured.
...
Want to extend your integration further? Explore the [Advanced SDK Usage](/developer-guide/configuration-guides/capturing-user-sessions/advanced-sdk-usage) guide to unlock features like custom event tracking, devtools links, and user metadata enhancements.
