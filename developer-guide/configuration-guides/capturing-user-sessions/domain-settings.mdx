...
## Overview
- **What this section is for**: Configure what PlayerZero captures on a per-domain basis.
- **Key benefits**:
  - Enable or disable recording per environment.
  - Control visibility of Devtools UI.
  - Prevent noisy development environments from affecting insights.
- **Who this is for**: Developers managing multiple deployment environments like production, staging, QA, and local.
