...
## Overview
- **What this section is for**: This page covers the advanced usage of the PlayerZero Web SDK after basic initialization.
- **Key benefits**:
  - Unlock deeper insight and control with PlayerZero's developer tools.
  - Add custom analytics, build UI integrations, and troubleshoot edge cases.
- **Who this is for**: Developers looking to fine-tune PlayerZero's behavior, customize devtools triggers, or resolve integration edge cases.
...
- **[Domain Controls](/docs/domain-controls)**  
  Adjust PlayerZero's behavior by environment, hostname, or domain.

- **[Thresholds and Filtering](/docs/integrations/devtools)**  
  Customize how your team uses PlayerZero's debugging tools.
