...
<Note>Organization **Owner** access is required in PlayerZero to configure SSO. **Okta Administrator** access is required in Azure to create the app registration and adjust settings.</Note>
