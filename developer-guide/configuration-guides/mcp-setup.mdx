...
sidebarTitle: "PlayerZero MCP Server"
description: "PlayerZero exposes an MCP server that any compatible AI assistant can connect to, bringing codebase intelligence, live telemetry, and issue context directly into your editor."
---
