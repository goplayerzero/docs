...
- Delete unused tokens from **Settings → Personal Access Tokens**
</Accordion>
...
- **Use prompt templates** (type `@` in the question box) to standardize recurring analysis questions across your team
...
- Generate a new token if needed from **Settings → Personal Access Tokens** in the web app
</Accordion>
