...
Official reference:  
👉 [OpenTelemetry .NET Configuration](https://opentelemetry.io/docs/instrumentation/net/configuration/)
...
- [ASP.NET Core Instrumentation](https://opentelemetry.io/docs/instrumentation/net/instrumentation/aspnetcore/)
- [.NET SDK Configuration](https://opentelemetry.io/docs/instrumentation/net/configuration/)
