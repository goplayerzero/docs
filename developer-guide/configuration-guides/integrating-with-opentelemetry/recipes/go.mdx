...
Official reference:  
👉 [Go SDK Configuration](https://opentelemetry.io/docs/instrumentation/go/sdk/)
...
- [Go SDK Setup and Configuration](https://opentelemetry.io/docs/instrumentation/go/sdk/)
