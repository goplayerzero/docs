...
Learn more:  
👉 [Rust Manual Instrumentation Guide](https://opentelemetry.io/docs/instrumentation/rust/manual/)
...
Official reference:  
👉 [Rust OTLP Exporter Setup](https://opentelemetry.io/docs/instrumentation/rust/exporters/otlp/)
...
- [Rust Manual Tracing](https://opentelemetry.io/docs/instrumentation/rust/manual/)
