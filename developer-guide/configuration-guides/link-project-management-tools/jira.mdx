...
description: "Connect Jira Cloud projects to PlayerZero for real-time issue sync, defect traceability, and AI-powered debugging."
---
...
2. Check the **projects** you want to sync.
