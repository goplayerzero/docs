...
We believe in keeping your data secure.  To exclude files from being ingested from
your code repository into PlayerZero, please include a .pzignore file in repositories
root directory with exclude patterns just like .gitignore.  See [MDX](https://www.w3schools.com/git/git_ignore.asp?remote=github "this")
for examples of ignore statements.