...
<ul>
  <li>
    <VisibleLink 
      displayText="Ask Questions about Key Services, Files and Functions" 
      href="/use-cases/retrieve-insights-from-code/ask-codebase-questions" 
    />
  </li>
  <li>
    <VisibleLink 
      displayText="Identify Dependencies Across Files and Repos" 
      href="/use-cases/retrieve-insights-from-code/identify-dependencies" 
    />
  </li>
  <li>
    <VisibleLink 
      displayText="Enforce Coding Standards and Frameworks" 
      href="/use-cases/retrieve-insights-from-code/enforce-coding-standards" 
    />
  </li>
</ul>
