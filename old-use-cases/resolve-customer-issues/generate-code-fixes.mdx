...
This workflow kicks off after you’ve created a chat with PlayerZero, where work has already been done to create a context window and internal workspace around the issue at hand. To learn how to do this, read the [trace errors to code](/use-cases/resolve-customer-issues/trace-errors-to-code) guide.
...
<Note> PlayerZero keeps all context—code, debug data, and previous chats—readily available and interconnected, allowing you to build a complete understanding of the solution.</Note>
