...
<ul>
  <li>
    <VisibleLink 
      ...
      href="/use-cases/monitor-for-anomalies/setup-performance-alerts" 
    />
  </li>
  <li>
    <VisibleLink 
      displayText="Monitor API Latency and Server Performance" 
      href="/use-cases/monitor-for-anomalies/monitor-runtime-performance" 
    />
  </li>
  <li>
    <VisibleLink 
      displayText="Mute Unwanted Notifications and Alerts" 
      href="/use-cases/monitor-for-anomalies/reduce-alert-noise" 
    />
  </li>
  <li>
    <VisibleLink 
      displayText="Identify Issues Caused by New releases and Deployments " 
      href="/use-cases/monitor-for-anomalies/identify-deployment-issues" 
    />
  </li>
</ul>
