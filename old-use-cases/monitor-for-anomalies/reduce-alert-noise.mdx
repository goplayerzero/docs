...
Begin by navigating to the [Logs Page](https://go.playerzero.app/logs) in PlayerZero. Here, you will find all errors and logs being passed into the PlayerZero platform. 
...
Learn about how PlayerZero actively tracks and alerts teams to any issues that emerge after a deployment in the [Setup Alerts for User Issues](/use-cases/monitor-for-anomalies/setup-performance-alerts) guide.
