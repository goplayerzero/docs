...
<CardGroup cols={2}>
    <Card title="Frontend Developer" icon="computer" href="/user-guides/prompting-tips-and-tricks#frontend-developer">
    Find reusable components, optimize user experience, debug frontend issues and more.
    </Card>
    <Card title="Backend Engineer" icon="code" href="/user-guides/prompting-tips-and-tricks#backend-engineer">
    Map service dependencies, optimize performance, debug distributed systems and more.
    </Card>
    <Card title="Support" icon="heart" href="/user-guides/prompting-tips-and-tricks#support">
    Translate user problems, find solutions, prepare technical escalations and more.
    </Card>
    <Card title="Data Analyst" icon="folders" href="/user-guides/prompting-tips-and-tricks#data-analyst">
    Understand data models, trace business calculations, ensure data integrity and more.
    </Card>
    <Card title="QA Engineer" icon="list" href="/user-guides/prompting-tips-and-tricks#qa-engineer">
    Design comprehensive tests, identify edge cases, and ensure system quality.
    </Card>
    <Card title="Business Analyst" icon="briefcase" href="/user-guides/prompting-tips-and-tricks#business-analyst">
    Map architecture, trace business rules to code, and accelerate domain understanding.
    </Card>
</CardGroup>
