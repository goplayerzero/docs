...
<AccordionGroup>
  ...
  <Accordion title="Trace Issues to Code">
    ...
    <CardGroup cols={1}>
      <Card title="Learn more about tracing issues to code with PlayerZero" icon="code" href={'/user-guides/trace-issues-to-code'}>
      </Card>
    </CardGroup>
  </Accordion>
  ...
  <Accordion title="Accelerate Fixes with Intelligent Guidance">
    ...
    <CardGroup cols={1}>
      <Card title="Learn more about accelerating fixes with PlayerZero" icon="wrench" href={'/user-guides/accelerate-fixes-with-guidance'}>
      </Card>
    </CardGroup>
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Visualize System Architecture">
    ...
    <CardGroup cols={1}>
      <Card title="Learn more about visualizing system architecture with PlayerZero" icon="diagram-project" href={'/user-guides/visualize-system-architecture'}>
      </Card>
    </CardGroup>
  </Accordion>
  ...
  <Accordion title="Detailed API and Module Documentation">
    ...
    <CardGroup cols={1}>
      <Card title="Learn more about creating detailed API and module documentation with PlayerZero" icon="book-open" href={'/user-guides/detailed-api-and-module-documentation'}>
      </Card>
    </CardGroup>
  </Accordion>
  ...
  <Accordion title="Surface Code Conventions and Patterns">
    ...
    <CardGroup cols={1}>
      <Card title="Learn more about surfacing code conventions and patterns with PlayerZero" icon="code" href={'/user-guides/code-conventions-and-patterns'}>
      </Card>
    </CardGroup>
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Explore Complex System Architecture">
    ...
    <CardGroup cols={1}>
      <Card title="Learn more about exploring system architecture with PlayerZero" icon="server" href={'/user-guides/explore-system-architecture'}>
      </Card>
    </CardGroup>
  </Accordion>
  ...
  <Accordion title="Learn Business Rules and Team Patterns">
    ...
    <CardGroup cols={1}>
      <Card title="Learn more about learning business rules and team patterns with PlayerZero" icon="folder" href={'/user-guides/learn-business-rules-and-patterns'}>
      </Card>
    </CardGroup>
  </Accordion>
  ...
  <Accordion title="Accelerate Environment Setup and Ramp">
    ...
    <CardGroup cols={1}>
      <Card title="Learn more about accelerating environment setup and ramp with PlayerZero" icon="rocket" href={'/user-guides/accelerate-environment-setup'}>
      </Card>
    </CardGroup>
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Migrate Across Frameworks or Languages">
    ...
    <CardGroup cols={1}>
      <Card title="Learn more about migrating across frameworks or languages with PlayerZero" icon="shuffle" href={'/user-guides/migrate-frameworks-languages'}>
      </Card>
    </CardGroup>
  </Accordion>
  ...
  <Accordion title="Understand Legacy and Foreign Code">
    ...
    <CardGroup cols={1}>
      <Card title="Learn more about understanding legacy and foreign code with PlayerZero" icon="glasses" href={'/user-guides/understand-legacy-code'}>
      </Card>
    </CardGroup>
  </Accordion>
  ...
  <Accordion title="Refactor for Performance and Maintainability">
    ...
    <CardGroup cols={1}>
      <Card title="Learn more about refactoring for performance and maintainability with PlayerZero" icon="wrench" href={'/user-guides/refactor-for-performance'}>
      </Card>
    </CardGroup>
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Identify Comprehensive Test Scenarios">
    ...
    <CardGroup cols={1}>
      <Card title="Learn more about identifying comprehensive test scenarios with PlayerZero" icon="clipboard-list" href={'/user-guides/identify-test-scenarios'}>
      </Card>
    </CardGroup>
  </Accordion>
  ...
  <Accordion title="Trace Dependencies and Integration Risks">
    ...
    <CardGroup cols={1}>
      <Card title="Learn more about tracing dependencies and integration risks with PlayerZero" icon="magnifying-glass" href={'/user-guides/trace-integration-risks'}>
      </Card>
    </CardGroup>
  </Accordion>
  ...
  <Accordion title="Detect Code Quality and Security Vulnerabilities">
    ...
    <CardGroup cols={1}>
      <Card title="Learn more about detecting code quality and security vulnerabilities with PlayerZero" icon="shield" href={'/user-guides/detect-quality-vulnerabilities'}>
      </Card>
    </CardGroup>
  </Accordion>
