...
<Note>Tickets are never modified—PlayerZero reads metadata only to improve triage and issue resolution.</Note>

## Integrate Customer Support Tickets

[📖 Follow the Ticketing Integration Guide →](/developer-guide/configuration-guides/connect-customer-ticketing/sync-customer-ticket-data)
